import { getTOCOfBodyList } from '@components/Docs/Helpers/functions';
...
export function TocOfBody({
    ...
    headingSelector = headingSelector || "h1, h1, h2, h3, h4, h5, h6";
    const { inViewId } = useInViewId(Ref, headingSelector);
    const heading = getTOCOfBodyList(content);

    const [expansion, setExpansion] = useState(State.Collapsed);
